...
- **Rama de origen (repo de equipo):** `feature/asii-03-pacientes-glendi20`
- **Repo/rama de esta copia (repo personal):** ver README.md de esta rama
- **Commit evaluado:** _(completar con `git rev-parse HEAD` al momento de abrir el PR/entregar)_

> Nota: este archivo documenta el trabajo tal como se hizo originalmente en el repositorio de
> equipo. Esta rama del repositorio personal es una copia ejecutable acotada solo a este módulo
> (ver README.md), por lo que algunos comandos de esta sección deben repetirse aquí de forma
